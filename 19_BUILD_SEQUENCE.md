...
- [ ] Post-capture floating overlay window (always-on-top, non-activating): thumbnail, Confirm / Ignore / Ask AI placeholders, auto-dismiss timer <!-- partial: hidden-until-decode display-correct overlay 91e6643; generation-safe Copy, atomic Save As, Close, and hover/action-paused auto-dismiss 8923e90; exact restore 8bd0888; copy-only native drag-out db0ab1e; and queue-timestamped five-item thumbnail history plus Open Library e0b1020 are Checker-approved; native focus/relaunch/multi-display/interaction QA and AI placeholders remain -->
