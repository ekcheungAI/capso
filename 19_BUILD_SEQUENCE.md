...
- [ ] Post-capture floating overlay window (always-on-top, non-activating): thumbnail, Confirm / Ignore / Ask AI placeholders, auto-dismiss timer <!-- partial: hidden-until-decode display-correct overlay 91e6643 plus generation-safe Copy, atomic Save As, Close, and hover/action-paused auto-dismiss 8923e90 are Checker-approved; Annotate, native drag-out, recent restore, and native focus/multi-display QA remain -->
...
**Tasks:**
- [ ] Annotation editor on overlay/detail: arrow, box, text, blur; flattened annotated PNG uploaded as the stored version (AC-ANN-01)
